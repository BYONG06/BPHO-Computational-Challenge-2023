...
planet.penup()
planet.goto(0, 300)
planet.write("Inner Planets", font=("Courier", 30, "bold"), align = "center")
...
mercuryP = pandas.read_excel("Challenge 3 Data.xlsx", sheet_name="Challenge 3 test", usecols ="M,N").to_numpy()
venusP = pandas.read_excel("Challenge 3 Data.xlsx", sheet_name="Challenge 3 test", usecols ="U,V").to_numpy()
earthP = pandas.read_excel("Challenge 3 Data.xlsx", sheet_name="Challenge 3 test", usecols ="AC,AD").to_numpy()
marsP = pandas.read_excel("Challenge 3 Data.xlsx", sheet_name="Challenge 3 test", usecols ="AK, AL").to_numpy()
t = pandas.read_excel("Challenge 3 Data.xlsx", sheet_name="Challenge 3 test", usecols ="H").to_numpy()
