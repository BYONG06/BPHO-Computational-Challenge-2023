...
def OP():
    ...
    graphing.legend(["Jupiter", "Saturn", "Uranus", "Neptune", "Pluto"], loc = "upper right")
    graphing.show()
...
def ALL():
    ...
    graphing.plot(neptunex, neptuney)
    graphing.plot(plutox, plutoy)
    graphing.legend(["Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune", "Pluto"], loc = "upper right")
    graphing.show()
